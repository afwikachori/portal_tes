        ...
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <h5 class="coren marl-2">Best Sellers</h5>
                    </div>
                    <div class="col-md">
                                    ...
                                    <div class="row modheadrow">
                                        ...
                                        <div class="col-md-3 col-sm-3 produk-slider">
                                            <article class="aa-blog-content-single">
                                                <figure class="aa-blog-img">
                                                    <a href="#">
                                                        <img class="produkpic" src="https://cf.shopee.sg/file/d4157703bbff2df3978683c41747a139"
                                                            alt="fashion img">
                                                    </a>
                                                </figure>
                                                <a class="aprodukslide" href="#">
                                                    ...
                                                    <div class="aa-article-bottom">
                                                        <small><span class="ico-bulet"><span class="fa fa-circle"></span></span>76</small>
                                                    </div>
                                                </a>
                                            </article>
                                        </div>
                                        ...
                                        <div class="col-md-3 col-sm-3 produk-slider">
                                            <article class="aa-blog-content-single">
                                                ...
                                                <a class="aprodukslide" href="#">
                                                    <small>laudantium laborum ipsa excepturi soluta, dolore similique.</small>
                                                    <div class="aa-article-bottom">
                                                        <small><span class="ico-bulet"><span class="fa fa-circle"></span></span>1207</small>
                                                    </div>
                                                </a>
                                            </article>
                                        </div>
                                        ...
                                        <div class="col-md-3 col-sm-3 produk-slider">
                                            <article class="aa-blog-content-single">
                                                <figure class="aa-blog-img">
                                                    <a href="#">
                                                        <img class="produkpic" src="https://cf.shopee.sg/file/40fe8834adeb7c27f30f345962520f79"></a>
                                                </figure>
                                                <a class="aprodukslide" href="#">
                                                    <small>accusamus dolorum ipsam adipisci laudantium laborum</small>
                                                    <div class="aa-article-bottom">
                                                        <small><span class="ico-bulet"><span class="fa fa-circle"></span></span>324</small>
                                                    </div>
                                                </a>
                                            </article>
                                        </div>
                                        ...
                                        <div class="col-md-3 col-sm-3 produk-slider">
                                            <article class="aa-blog-content-single">
                                                <figure class="aa-blog-img">
                                                    <a href="#">
                                                        <img class="produkpic" src="https://cf.shopee.sg/file/ddf1d7fd999b2dfb533e733c1d6ef529"></a>
                                                </figure>
                                                <a class="aprodukslide" href="#">
                                                    <small>Voluptates voluptatum accusamus dolorum ipsam adipisci laudantium </small>
                                                    <div class="aa-article-bottom">
                                                        <small><span class="ico-bulet"><span class="fa fa-circle"></span></span>98</small>
                                                    </div>
                                                </a>
                                            </article>
                                        </div>
